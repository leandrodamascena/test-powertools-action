...
@pytest.mark.parametrize("python_version", [lambda_.Runtime.PYTHON_3_8, lambda_.Runtime.PYTHON_3_9, lambda_.Runtime.PYTHON_3_10, lambda_.Runtime.PYTHON_3_11, lambda_.Runtime.PYTHON_3_12])
...
def test_with_custom_name():
    ...
    template.has_resource_properties("AWS::Lambda::LayerVersion", {
         "LayerName": "custom_name_layer"
     })
    
    template.has_resource_properties("AWS::Lambda::LayerVersion", {
         "Description": "Powertools for AWS Lambda (Python) V3 [x86_64 - Python 3.12] with extra dependencies latest version"
     })
...
def test_with_extras():
    ...
    template.has_resource_properties("AWS::Lambda::LayerVersion", {
         "Description": "Powertools for AWS Lambda (Python) V3 [x86_64 - Python 3.12] with extra dependencies version 3.0.0"
     })
...
def test_with_extras_arm64():
    ...
    template.has_resource_properties("AWS::Lambda::LayerVersion", {
         "Description": "Powertools for AWS Lambda (Python) V3 [arm64 - Python 3.12] with extra dependencies version 3.0.0"
     })
